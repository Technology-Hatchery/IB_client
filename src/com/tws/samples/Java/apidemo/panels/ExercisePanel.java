...
import com.tws.samples.Java.apidemo.panels.ExPanel;
...
public class ExercisePanel extends HorzPanel implements INewTab, IAccountHandler {
    private static DefaultListModel m_acctList = new DefaultListModel();
    public static JList m_accounts = new JList(m_acctList);
    private String m_selAcct = "";
    public static PortfolioModel m_portfolioModel = new PortfolioModel();
    public static JTable m_portTable = new JTable(m_portfolioModel);
