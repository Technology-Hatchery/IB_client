...
public class ApiDemo implements IConnectionHandler {
    ...
    //....
    private static JTextArea m_inLog = new JTextArea();
    private static JTextArea m_outLog = new JTextArea();
    private static Logger m_inLogger = new Logger(m_inLog);
    private static Logger m_outLogger = new Logger(m_outLog);
    public static ApiController m_controller = new ApiController(INSTANCE, m_inLogger, m_outLogger);
