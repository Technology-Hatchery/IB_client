...
void CTws::connect(LPCTSTR host, long port, long clientId)
{
	static BYTE parms[] =
...
void CTws::reqMktDataEx(LONG tickerId, IDispatch* contract,
						LPCTSTR genericTicks, BOOL snapshot)
{
	static BYTE parms[] = VTS_I4 VTS_DISPATCH VTS_BSTR VTS_BOOL;
	InvokeHelper(/* dispidReqMktDataEx */ 101, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		tickerId, contract, genericTicks, snapshot);
}

void CTws::reqMktDepthEx(LONG tickerId, IDispatch* contract, LONG numRows)
{
	static BYTE parms[] = VTS_I4 VTS_DISPATCH VTS_I4;
	InvokeHelper(/* dispidReqMktDepthEx */ 102, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		tickerId, contract, numRows);
}
...
void CTws::reqHistoricalDataEx(LONG tickerId, IDispatch* contract, LPCTSTR endDateTime,
		LPCTSTR duration, LPCTSTR barSize, LPCTSTR whatToShow, BOOL useRTH, LONG formatDate)
{
	static BYTE parms[] = VTS_I4 VTS_DISPATCH VTS_BSTR VTS_BSTR VTS_BSTR VTS_BSTR VTS_BOOL VTS_I4;
	InvokeHelper(/* dispidReqHistoricalDataEx */ 106, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		tickerId, contract, endDateTime, duration, barSize, whatToShow, useRTH, formatDate);
}

void CTws::reqRealTimeBarsEx(LONG tickerId, IDispatch* contract,
		LONG barSize, LPCTSTR whatToShow, BOOL useRTH)
{
	static BYTE parms[] = VTS_I4 VTS_DISPATCH VTS_I4 VTS_BSTR VTS_BOOL;
	InvokeHelper(/* dispidReqRealTimeBarsEx */ 107, DISPATCH_METHOD, VT_EMPTY, NULL, parms,
		tickerId, contract, barSize, whatToShow, useRTH);
}

void CTws::reqScannerSubscriptionEx(LONG tickerId, IDispatch* subscription)
{
	static BYTE parms[] = VTS_I4 VTS_DISPATCH;
