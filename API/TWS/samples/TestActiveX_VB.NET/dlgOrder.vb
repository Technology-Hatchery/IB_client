...
#End Region
    ...
    Public Sub init(ByRef dlgType As Dlg_Type, ByVal contractInfo As TWSLib.IContract, _
        ...
        txtIncludeExpired.Enabled = (dlgType = Dlg_Type.REQ_HISTORICAL_DATA Or _
                                     dlgType = Dlg_Type.REQ_CONTRACT_DETAILS_DLG Or _
                                     dlgType = Dlg_Type.REQ_REAL_TIME_BARS_DLG)
        ...
        Else
            ...
            Dim localSym As Boolean = dlgType <> Dlg_Type.REQ_HISTORICAL_DATA And _
                                    dlgType <> Dlg_Type.EXERCISE_OPTIONS
            txtLocalSymbol.Enabled = localSym
            txtTradingClass.Enabled = True
            TxtPrimaryExchange.Enabled = localSym
        End If
